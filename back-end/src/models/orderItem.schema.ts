...
export interface OrderItem extends CartItem, Document {
  orderId: ObjectId;
  status: Status;
  refundedAt: Date;
}

export const orderItem = new mongoose.Schema<OrderItem>(
  {
    orderId: {
...
const OrderItem = mongoose.model<OrderItem>("OrderItem", orderItem);
